        ...
        <Card sx={{ maxWidth: 1000 }}>
            <CardContent>
                ...
                <Typography variant="body2">
                    This component utilizes Material UI's Card component to create a visually appealing card with a heading, subheading, and body text.
                </Typography>
                <Button variant="contained" onClick={toggleReply}>Reply</Button>
