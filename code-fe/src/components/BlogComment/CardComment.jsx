      ...
      <div className={styles.customContainer}>
        <Container style={{ maxWidth: 'initial' }}>
          <div className={styles['container-content']}>
            ...
            <Text style={{ marginLeft: '10px', marginTop: '5px' }}>{comment.id}</Text>
            ...
            <Text style={{ marginLeft: '100px', marginTop: '5px', color: 'GrayText' }}>
        ...
        <Container style={{ maxWidth: 'initial', display: 'flex', alignItems: 'center' }}>
          {ReplyButton && (
            <Link style={{ marginLeft: '100px' }} onClick={handleReply}>
              <div class="action__1C-I">
                ...
                <span style={{ color: 'GrayText' }}>Reply</span>
              </div>
            </Link>
          )}
          {showReplyButton && (
            <Link style={{ marginLeft: '50px' }} onClick={handleShowAllReplies}>
              <div class="action__1C-I">
                <svg viewBox="0 0 24 24" width="1em" height="1em" class="icon__1Md2">
                  <path
                    fill-rule="evenodd"
                ...
                <span style={{ color: 'GrayText' }}>Show replies</span>
              </div>
            </Link>
          )}
        </Container>
